            ...
            if (!empty($Sous_Categories)): ?>
                <?php foreach ($Sous_Categories as $Sous_Categorie): ?>
                    <tr class="border-b">
                        ...
                        <td class="py-2 text-center">
                            <form action="Controller/sousCategorieController.php">
                                <input type="number" name="sous_categorie_id" value="<?= $Sous_Categorie['id_sous_categorie']; ?>" class="hidden">
                                <button type="submit" class="text-blue-500 hover:underline">Modifier</button>
                                <button type="submit" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet Sous Categories ?');" class="text-red-500 hover:underline">Supprimer</button>
                            </form>
